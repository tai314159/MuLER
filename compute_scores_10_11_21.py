...
########
DIR_OUT = "/cs/snapless/oabend/tailin/MT/NEW/outputs/20.10.21/new/"
DIR_OUT_RESULTS = "/cs/snapless/oabend/tailin/MT/NEW/outputs/12.11.21/"
...
ref_input = "/cs/snapless/oabend/borgr/SSMT/data/submissions/wmt"+str(year)+"/plain/references/newstest20"+str(year)+"-"+src_lang+trg_lang+"-ref.en.txt"
...
DIR_DATA = "/cs/snapless/oabend/borgr/SSMT/data/submissions/wmt20/plain/system-outputs/de-en/"

for filename in os.listdir(DIR_DATA):
    if filename != "newstest2020.de-en.Human-B.0.txt":
        ...
        print("newstest2018.JHU.5675.ru-en")
...
ref_input = "/cs/snapless/oabend/borgr/SSMT/data/submissions/wmt"+str(year)+"/plain/references/newstest20"+str(year)+"-"+src_lang+trg_lang+"-ref.en.txt"
DIR_DATA = "/cs/snapless/oabend/borgr/SSMT/data/submissions/wmt"+str(year)+"/plain/system-outputs/newstest20"+str(year)+"/"+src_lang+"-"+trg_lang+"/"
filename = "newstest2020.de-en.UEDIN.1066.txt"

filename = "/cs/snapless/oabend/borgr/SSMT/data/submissions/wmt20/plain/system-outputs/de-en/newstest2020.de-en.UEDIN.1066.txt"

#candidates_inputs = [[DIR_DATA+filename]]
candidates_inputs = [[filename]]
mask_types = ["pos","ner","feat"]
...
for mask_type in mask_types:
    ...
    for candidates_input in candidates_inputs:
        ...
        save_pickle(DIR_OUT_RESULTS +src_lang+"-"+trg_lang+"_"+mask_type+"_"+"newstest2020.de-en.UEDIN.1066.txt",result)
