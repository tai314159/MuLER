...
#note: The only thing that changed is that an argument was added to run_main() --> last argument can be:
#1. score_type = 'bleu'
#2. score_type = None (then it will treat this like 'bleu')
#3. score_type - 'rouge' (summarization)
#PLUS: The data for summarization is in "summarization_data" directory (there is 1 reference file, multiple candidate files, outputs from various models)
