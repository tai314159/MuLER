...
CACHE = '/cs/labs/oabend/gal.patel/stanza'
...
def compute_scores(reference_input, candidate_input, DIR_OUT, parsed_model_ref,
                   parsed_model_candidate, mask_list_path, mask_type=None):
    ...
    # print("@@@")
    # print("len(ref_sentences),len(candidate_sentences):", len(ref_sentences),
    ...
    bleu_not_masked, bleu_not_masked_list = score_sentence_bleu(reference_input, candidate_input,
    ...
    for mask in mask_list:
        ...
        if len(indices) == 0:
            ...
            score_masked, _ = score_sentence_bleu(masked_ref, masked_candidate, indices,
                                                  save_score=False)
            ...
            #     pass
            #     with open(
            #             "/cs/snapless/oabend/tailin/MT/NEW/logs/" + mask_type + "_negative_bleu.txt",
            #             "a") as outfile:
...
def run_main(DIR_OUT, mask_list_path, ref_input, candidates_input, mask_type, trg_lang="en",
             max_bleu_dict_path=None, run_all=False):
    """
    :param DIR_OUT:
...
# result = run_main(DIR_OUT, mask_list_path, ref, candidates,mask_type, trg_lang = "en",
# max_bleu_dict_path = None, run_all = False)
